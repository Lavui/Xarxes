...
void lan_block_put(const missatge_lan_t m, uint8_t nd, lan_buffer_t prioritat);//té dos paràmetres. El primer és el missatge que es vol transmetre en forma de taula missatge_lan_t . El segon és l'adreça del node a qui va dirigit.
